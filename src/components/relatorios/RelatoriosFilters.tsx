...
export function RelatoriosFilters() {
  const { period, setPeriod, doctorFilter, setDoctorFilter } = useRelatorios()

  return (
    <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 p-5 bg-white/80 backdrop-blur-md border rounded-2xl sticky top-4 z-10 shadow-sm mb-6">
